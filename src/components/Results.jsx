...
function Results({ calories }) {
  ...
  return (
    <div className="table py-12 mx-auto overflow-x-auto ">
      <table className="border-2 border-green-600 text-sm text-center text-green-500 font-bold  table-auto max-w-3xl divide-y divide-green-600">
        ...
        <tbody>
          <tr className="border-b bg-gray-800 border-green-700 ">
            <td className="px-6 py-4">{Math.round(BMR)}</td>

            <td className="px-6 py-4">{Math.round(maintainWeightCalories)}</td>

            <td className="px-6 py-4">{Math.round(mildWeightLoss)}</td>

            <td className="px-6 py-4">{Math.round(weightLoss)}</td>

            <td className="px-6 py-4">{Math.round(extremeWeightLoss)}</td>

            <td className="px-6 py-4">{Math.round(mildWeightGain)}</td>

            <td className="px-6 py-4">{Math.round(weightGain)}</td>

            <td className="px-6 py-4">{Math.round(extremeWeightGain)}</td>
          </tr>
        </tbody>
      </table>
    </div>
